...
optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001)  #官方一张卡，batch size=2，按理说lr应该设置成0.0025，但却设置成0.005
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=2000)))
work_dir = '/opt/data/private/shen/mmrotate-0.3.3/work_dir/grad_fpn'
seed = 518
gpu_ids = range(0, 1)
