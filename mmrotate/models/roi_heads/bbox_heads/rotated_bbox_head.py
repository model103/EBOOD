...
class RotatedBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 reg_decoded_bbox=True,  #改动，基于Iou的loss使用T
    ...
    def get_targets(self,
        ...
        return labels, label_weights, bbox_targets, bbox_weights   #, img #改动
    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                kwargs = dict(oringin_img = img) #改动
                losses['loss_bbox'] = self.loss_bbox(
                    ...
                    reduction_override=reduction_override,
                    **kwargs  #改动，使用其他loss时去掉这个(非myloss)
                    )
            else:
